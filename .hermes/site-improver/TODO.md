...
**Cycle state (2026-07-05):** The original priority list (10 items: SE-01, SE-03, SE-04, SE-05, T-01, T-03, T-04, C-01, C-02, C-05) is **fully drained** — all are marked `[x]` in the checklists below with completion notes. T-12 (2026-07-02) closed the last formal TODO item; SE-07 (2026-07-03) added a Google-recommended `MedicalCondition.pathophysiology` field; T-13 (2026-07-05) added FAQ accordion expand/collapse tracking. The 37 items tracked in this file (S-01 → S-09, SE-01 → SE-07, T-01 → T-13, C-01 → C-05, WD-01 → WD-06) are all shipped and rolled into PR #41.

1. **T-13** — FAQ accordion expand/collapse tracking. ✅ DONE 2026-07-05 — see Tracking category checklist. Last shipped: T-13.
