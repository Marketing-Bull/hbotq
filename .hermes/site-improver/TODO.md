...
**Cycle state (2026-07-10):** The original priority list (10 items: SE-01, SE-03, SE-04, SE-05, T-01, T-03, T-04, C-01, C-02, C-05) is **fully drained** — all are marked `[x]` in the checklists below with completion notes. T-12 (2026-07-02) closed the last formal TODO item; SE-07 (2026-07-03) added `MedicalCondition.pathophysiology`; T-13 (2026-07-05) added FAQ accordion tracking; T-14 (2026-07-09) closed the last untracked internal link surface; S-10 (2026-07-10) added `MedicalBusiness` schema to the 6 new post-merge route families. The 39 items tracked in this file (S-01 → S-10, SE-01 → SE-07, T-01 → T-14, C-01 → C-05, WD-01 → WD-06) are all shipped and rolled into PR #41.

1. **S-10** — MedicalBusiness schema on new post-merge routes (wellness, resources, physicians/[slug], videos). ✅ DONE 2026-07-10 — see Schema category checklist. Last shipped: S-10.

**Future audit-driven candidates** (no `[ ]` items; these are leads for the next cycle's audit, not commitments):
- **S-11** — Fix pre-existing validator errors (8 errors from main-branch merge): 6× review arrays emitted as `[{...}]` array instead of individual `<script>` blocks on condition pages; VideoObject type has no deep validator. Both are validator/schema issues introduced by the main-branch expansion, not this branch.
